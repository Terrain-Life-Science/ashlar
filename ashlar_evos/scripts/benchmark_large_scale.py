...
Examples:
  ...
  python -m ashlar_evos.scripts.benchmark_large_scale cycle_*.ome.tif --output-dir benchmark/ --tile-size 2048
    ...
    parser.add_argument(
        ...
        nargs='+',
        type=str,
        help='Input cycle OME-TIFF files. Supports glob patterns.'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=4096,
        help='Tile size for processing (default: 4096)'
    )
    ...
    parser.add_argument(
        '--coarse-only',
        action='store_true',
        help='Skip fine registration (coarse alignment only)'
    )
